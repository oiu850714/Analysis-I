...
Let \(A, B, X\) be sets such that \(A \cup B = X\) and \(A \cap B = \emptyset\). (\href{https://www.wikiwand.com/en/Partition_of_a_set}{partition}) Show that \(A = X \setminus B\) and \(B = X \setminus A\).
\end{exercise}
